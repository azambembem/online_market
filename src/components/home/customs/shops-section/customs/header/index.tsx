...
const Header = () => {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-8 md:gap-[180px] items-center">
      <h1 className="text-[24px] sm:text-[28px] font-bold text-black text-center">
        Flash Sales
      </h1>
      ...
      <Carousel className="w-full sm:w-[80%] md:w-[50%]">
        <CarouselContent>
          <CarouselItem></CarouselItem>
          <CarouselItem></CarouselItem>
          <CarouselItem></CarouselItem>
